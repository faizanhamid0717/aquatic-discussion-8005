    ...
    return(<>
        ...
        <Box mb={"20px"} >
            <Box  margin={"auto"} mt={"150px"} width={"330px"} height={"390px"} boxShadow="rgba(0, 0, 0, 0.24) 0px 3px 8px" >
                ...
                <Text color="gray"  textAlign={"start"}  m={"18px 30px "} fontSize={"12"} >Please provide your Mobile Number or Email to Login/ Sign Up on Snapdeal. eve.holt@reqres.in</Text>
                <Input value={email} onChange={(e)=>{setEmail(e.target.value)}} borderRadius="0px" pl={"8px"} placeholder="Email" border={"1px solid grey"} height={"35px"} width={"270px"} ></Input>
