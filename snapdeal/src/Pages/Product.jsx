...
const Product = () => {
  ...
  return (<div  >
    ...
    {/* <Flex style={{border:"1px solid blue"}} ml="20px" justifyContent={"space-around"} width={"50%"} >
    ...
    <Flex direction={{base:"column",md:"row"}} >
     <Box>
      ...
      {/* ******************************************PRODUCTS******************************************** */}
      <Box ml={{md:"20px"}} >
        <Flex width={"100%"} justifyContent={"space-between"} direction={{ base: "column", lg: "row" }}  >
          <Flex>

            <h1 style={{ fontSize: '30px', marginRight: "10px" }}>ALL ITEMS </h1>
          ...
          <Box>
            ...
            <div style={{ border: "1px solid gray", width: '250px', height: '45px', paddingTop: '6px', marginTop: '8px', borderRadius: '5px' }}>
        ...
        <Grid  gridTemplateColumns={{base:"repeat(1,1fr)",sm:"repeat(2,1fr)",md:"repeat(2,1fr)",lg:"repeat(5,1fr)"}} gap={"10px"} >
          {data?.map((ele) =>
