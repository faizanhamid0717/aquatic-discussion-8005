      ...
      >
        <Box width={{ lg: "75%", md: "100%", sm: "100%" }} p={5}>
          <Accordion
            ...
            borderRadius="10px"
            width={{ lg: "100%", md: "400px", sm: "360px" }}
          >
              ...
              <h2>
                <AccordionButton>
                  <Box
                    ...
                    color={login == true ? "white" : "gray.600"}
                    backgroundColor={login == true ? "black" : "white"}
                    borderRadius="10px"
                    p={2}
                    textAlign="left"
                  >
                    <Alert status="success" variant="none">
                      <Flex direction={{ lg: "row", sm: "column" }}>
                        {login == false && (
                          <AlertIcon color="green" boxSize={6} />
                        )}
                        <Text color={login ? "white" : "gray.600"}>
                          1.Login
                        </Text>
                        {login == false && (
                          <Text ml={{ lg: "200px" }}>{user?.email}</Text>
                        )}
                      </Flex>
                    </Alert>
                    {/* Section 1 title */}
              ...
              <h2>
                <AccordionButton>
                  <Box
                    ...
                    flex="1"
                    onClick={() => setadd(!add)}
                    color={add == true ? "white" : "gray.600"}
                    backgroundColor={add == true ? "black" : "white"}
                    borderRadius="10px"
                    p={2}
                    textAlign="left"
                  >
                          ...
                          <Box ml={{ lg: "150px" }}>
                            {showadr.address && (
                              <Box>
                                ...
                                <Text>
                                  {`${showadr.city} - ${showadr.pincode}, ${showadr.state}`}{" "}
              ...
              <h2>
                <AccordionButton>
                  <Box
                    ...
                    color={review == true ? "white" : "gray.600"}
                    backgroundColor={review == true ? "black" : "white"}
                    borderRadius="10px"
                    p={4}
                    textAlign="left"
                  >
              ...
              <h2>
                <AccordionButton>
                  <Box
                    ...
                    flex="1"
                    onClick={() => setpay(!pay)}
                    color={pay == true ? "white" : "gray.600"}
                    backgroundColor={pay == true ? "black" : "white"}
                    borderRadius="10px"
                    p={4}
                    textAlign="left"
                  >
        ...
        >
          ...
          <Flex justifyContent="space-between" mt={5}>
            <Text>Total:</Text>
            <Text>
              Rs.{cart.reduce((c, el) => c + el.product.price * el.quntity, 0)}
            </Text>
          </Flex>
